...
class Excercise15(Scene):
    def construct(self):
        # Title
        title = Tex(r"Solution to $f(x) = 5 - 2x$", font_size=50).set_color(BLUE)
        title1 = Tex(r"The Graph of  $f(x) = 5 - 2x$", font_size=50).set_color(BLUE)
        ...
        explanation = Tex(
            r"""
            Explanation: $f(x) = 5 - 2x$ is a linear function.\\
            There are no restrictions on $x$ (e.g., no division by zero or square roots).\\
